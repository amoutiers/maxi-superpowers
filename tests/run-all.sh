...
run_check "$TESTS_DIR/check-design-operation.sh" "Bounded design operation continuity"
...
run_check "$TESTS_DIR/check-revise.sh"           "revise invariant checks"
...
run_check "$TESTS_DIR/check-hermes-plugin.sh" "Hermes plugin validation"
