...
These skills are vendored from [superpowers v6.1.1](https://github.com/obra/superpowers). Do not hand-edit them — run `scripts/sync-superpowers.sh` after any version bump.
