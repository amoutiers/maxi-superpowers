...
- `/maxi:implement` resumes from `implementing` if an earlier run was interrupted — the adapter reconciles content-bound Git completions before selecting pending work.
