...
- **Copy template first.** When creating a new constitution, copy `templates/constitution-template.md` into `docs/constitution.md` before writing anything. Use the template's section structure.
